...
public class ScriptableObjectAssetUtil
{
    ...
    private static void CreateScriptableObjectAssetMenuCommand(MenuCommand command)
    {
        ...
        var scriptPath = Path.GetDirectoryName(assetPath.Replace("Assets/","")) + "\\";
        var path = EditorUtility.SaveFilePanelInProject("Save asset as .asset", scriptPath + scriptType.Name + ".asset", "asset", "Please enter a file name");
